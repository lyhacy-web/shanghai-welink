...
const ConnectView: React.FC<ConnectViewProps> = ({ lang, userProfile, onAiChatStart, session }) => {
  ...
  const avatars = {
    ...
    you: session?.user?.email ? `https://api.dicebear.com/7.x/avataaars/svg?seed=${session.user.email}` : "https://lh3.googleusercontent.com/aida-public/AB6AXuBec6QstvBcsp7IjIxA8NzP9FM944pZm98ROmF9xVhBFJeXxdC7PytKRIkrDSJcp5bhNXANMjW00IDwhCklXY2jYsQRKTMozR4yXPpg3FrFFuCnHb1I2vid0RvmsqhNaNSRCQeA33VSqBrZhoO55FaSrWtZaX7nSpYEa56_lqXXqU_6ixx8kWM7RjAtfHf5EWMAku3G9h0IOjMhml-xOSAxcgEv1L0gNPLlvSxBSdVnBoHt6dbAqvHCcIk-S_M8qJ8ai53-fMrdwEQ",
  };
