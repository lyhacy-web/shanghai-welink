      ...
      <div className="sticky top-0 z-40 bg-background-light/95 dark:bg-background-dark/95 backdrop-blur-md border-b border-slate-100 dark:border-white/5 shadow-sm">
        <div className="flex items-center p-5 justify-between">
          ...
          <div className="flex flex-col items-center flex-1">
            <h2 className="text-[#0d1b14] dark:text-white text-2xl font-black tracking-tighter italic leading-none drop-shadow-sm">super hub</h2>
            <p className="text-[10px] text-primary font-black uppercase tracking-[0.2em] mt-1">Community Pulse</p>
          </div>
        ...
        >
          ...
          <div className="relative z-10">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="text-[#0d1b14] dark:text-white text-xl font-black tracking-tight italic">AI-Generated Digest</h3>
            </div>
            <p className="text-slate-600 dark:text-slate-300 text-sm font-bold leading-relaxed mb-8 max-w-[80%]">
              Stay updated with the most discussed topics and expert tips from our community this week.
            </p>
            <motion.button 
